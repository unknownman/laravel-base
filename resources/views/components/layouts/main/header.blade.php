<nav class=" dark bg-blue-800" x-cloak>
    <div class="py-3 px-3 lg:px-5 lg:pl-3">
        <div class="flex justify-between items-center">
            <div class="flex justify-start items-center">
                <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                    class="p-2 mr-2 text-white rounded cursor-pointer lg:hidden hover:text-white hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100">
                ...
                <span
                    class="hidden md:inline-block text-teal-50 self-center text-xl font-bold whitespace-nowrap">{{ __(config('app.name')) }}
                </span>
            ...
            <div class="flex items-center">
                <button id="toggleSidebarMobileSearch" type="button"
                    class="p-2 text-gray-500 rounded-2xl lg:hidden hover:text-white hover:bg-gray-100">
